        ...
        <a-col :span="18" :offset="3">
          <div class="ktcon">
            <a-row class="control-bar" justify="space-between">
              <a-col class="control-title">全部课程</a-col>
              <a-row justify="start" :gutter="[10, 0]" align="middle">
                <a-col><a>课程排序</a></a-col>
                <a-col>
                  <a-dropdown v-model:open="dropdownOpen">
                    <a-button type="primary">创建/加入课程</a-button>
                    <template #overlay>
                      <a-menu>
                        <a-menu-item key="create">创建课程</a-menu-item>
                        <a-menu-item key="join">加入课程</a-menu-item>
                      </a-menu>
                    </template>
                  </a-dropdown>
                </a-col>
            ...
            <a-row :gutter="[21, 30]" justify="start">
              <a-col v-for="course in courses" :key="course.scid || course.cid" :span="8">
